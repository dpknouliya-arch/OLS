                    ...
                    <div class="billingAndDelivery">
                        ...
                        <div class="grid2">
                            <div class="boxes">
                                ...
                                <fieldset class="grid2 singleFrom">
                                    <div class="form-group column2">
                                        ...
                                        <span class="error-msg" id="error-bi_company_name" style="color: #ff6b6b; font-size: 12px; display: none;"></span>
                                    </div>
                                    <div class="form-group column2">
                                        ...
                                        <span class="error-msg" id="error-bi_contact" style="color: #ff6b6b; font-size: 12px; display: none;"></span>
                                    </div>
                                    <div class="form-group column2">
                                        ...
                                        <span class="error-msg" id="error-bi_country" style="color: #ff6b6b; font-size: 12px; display: none;"></span>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <span class="error-msg" id="error-bi_city" style="color: #ff6b6b; font-size: 12px; display: none;"></span>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <span class="error-msg" id="error-bi_zip_code" style="color: #ff6b6b; font-size: 12px; display: none;"></span>
                                    </div>
                                    <div class="form-group  ">
                                        ...
                                        <span class="error-msg" id="error-bi_email" style="color: #ff6b6b; font-size: 12px; display: none;"></span>
                                    </div>
                                    <div class="form-group  ">
                                        ...
                                        <span class="error-msg" id="error-bi_tel" style="color: #ff6b6b; font-size: 12px; display: none;"></span>
                                    </div>
                                    <div class="form-group column2">
                                        ...
                                        <span class="error-msg" id="error-bi_tax_id" style="color: #ff6b6b; font-size: 12px; display: none;"></span>
                                    ...
                                    <div class="form-group column2">
                                        ...
                                        <span class="error-msg" id="error-bi_address" style="color: #ff6b6b; font-size: 12px; display: none;"></span>
                                    </div>
                                </fieldset>
                            </div>
                            <div class="boxes">
                                ...
                                <fieldset class="grid2 singleFrom">
                                    ...
                                    <div class="form-group  ">
                                        <label for="" class="w-100 text-start  c-label">Tel.</label>
                            ...
                            <div class="submitBUtton column2">
                                 <a class="themeBtn switch-tab iconBTn  billing_switch_info" data-target="#order" data-bs-toggle="tab" href="#order" role="tab"
                                aria-controls="order" aria-selected="false">
                ...
                <div class="tab-pane fade" id="order">
                    <div class="boxes">
                        ...
                        <fieldset class="grid2 singleFrom">
                            <div class="form-group  ">
                                ...
                                <input type="text" name="project_name" value="" placeholder="Order Name">
                            </div>
                            <div class="form-group  ">
                                <label for="" class="w-100 text-start  c-label">Customer PO</label>
                                <input type="text" name="customer_po" value="" placeholder="Customer PO">
                            </div>
                            <div class="form-group  ">
                                <label for="" class="w-100 text-start  c-label">Game / Event date</label>
                                <input type="date" name="game_event_date" value="" placeholder="Game / Event date">
                            </div>
                            <div class="form-group">
                                <label for="" class="w-100 text-start  c-label">Request due date</label>
                                <input type="date" name="req_due_date" value="" placeholder="Request due date ">
                            </div>
                    ...
                    <div class="d-flex justify-content-between my-4">
                        ...
                        <div class="submitBUtton">
                            <a href="#" class="themeBtn iconBTn" id="btn-step2-continue">Save and Continue <figure class="m-0"><img src="images/vector/nextBtn.png" alt=""></figure></a>
                        </div>
                    </div>
                </div>
                                ...
                                <fieldset class="grid2 singleFrom">
                                    ...
                                    <div class="d-flex justify-content-between column2 formBottom">
                                        ...
                                        <div class="d-flex gap-2">
                                            <span class="themeBtn iconBTn" id="showTeamTabsSection">Save and Continue <figure class="m-0"><img src="images/vector/nextBtn.png" alt=""></figure></span>
                    ...
                    <div class="boxes border-none">
                        ...
                        <fieldset class="grid2 singleFrom">
                            ...
                            <div class="form-group  ">
                                ...
                                <input type="text" name="input_on_team_name" id="input_on_team_name_new" value=""
...
<script>    
    ...
    document.addEventListener('DOMContentLoaded', () => {
        const tabs = document.querySelectorAll('#myTab .nav-link'); // Select main tabs only
        const tabContent = document.querySelectorAll('.tab-pane'); // Select all tab content sections

        // Track completed steps
        let completedSteps = {
            billing: true, // First step is accessible by default
            order: false,
            team: false
        };
        ...
        function clearStep1Errors() {
            const fields = ['bi_company_name', 'bi_contact', 'bi_country', 'bi_city', 'bi_zip_code', 'bi_email', 'bi_tel', 'bi_tax_id', 'bi_address',
                           'de_company_name', 'de_contact', 'de_country', 'de_city', 'de_zip_code', 'de_email', 'de_tel', 'de_tax_id', 'de_address'];
        ...
        function validatePhoneNumber(phone) {
            // Allow digits, dashes, parentheses, plus sign at start
        ...
        function validateBillingStep() {
            ...
            const bi_contact = document.getElementById('bi_contact')?.value?.trim() || '';
            const bi_address = document.getElementById('bi_address')?.value?.trim() || '';
            const bi_city = document.getElementById('bi_city')?.value?.trim() || '';
            const bi_country = document.getElementById('bi_country')?.value?.trim() || '';
            const bi_zip_code = document.getElementById('bi_zip_code')?.value?.trim() || '';
            const bi_tel = document.getElementById('bi_tel')?.value?.trim() || '';
            const bi_email = document.getElementById('bi_email')?.value?.trim() || '';

            // Get values for Delivery
            const de_contact = document.getElementById('de_contact')?.value?.trim() || '';
            const de_address = document.getElementById('de_address')?.value?.trim() || '';
            const de_city = document.getElementById('de_city')?.value?.trim() || '';
            const de_country = document.getElementById('de_country')?.value?.trim() || '';
            const de_zip_code = document.getElementById('de_zip_code')?.value?.trim() || '';
            const de_tel = document.getElementById('de_tel')?.value?.trim() || '';
            const de_email = document.getElementById('de_email')?.value?.trim() || '';

            // Validate Billing Contact (required, text only)
            if (!bi_contact) {
                showFieldError('bi_contact', 'Contact is required');
                isValid = false;
                if (!firstErrorField) firstErrorField = 'bi_contact';
            }

            // Validate Billing Address
            if (!bi_address) {
                showFieldError('bi_address', 'Address is required');
                isValid = false;
                if (!firstErrorField) firstErrorField = 'bi_address';
            }

            // Validate Billing City
            if (!bi_city) {
                showFieldError('bi_city', 'City is required');
                isValid = false;
                if (!firstErrorField) firstErrorField = 'bi_city';
            }

            // Validate Billing Country
            if (!bi_country) {
                showFieldError('bi_country', 'Country is required');
                isValid = false;
                if (!firstErrorField) firstErrorField = 'bi_country';
            }

            // Validate Billing Zipcode
            if (!bi_zip_code) {
                showFieldError('bi_zip_code', 'Zipcode is required');
                isValid = false;
                if (!firstErrorField) firstErrorField = 'bi_zip_code';
            }

            // Validate Billing Tel (required, phone format)
            if (!bi_tel) {
                showFieldError('bi_tel', 'Tel. is required');
                isValid = false;
                if (!firstErrorField) firstErrorField = 'bi_tel';
            } else if (!validatePhoneNumber(bi_tel)) {
                showFieldError('bi_tel', 'Please enter a valid telephone number (only numbers, -, (), and spaces allowed, min 7 digits)');
                isValid = false;
                if (!firstErrorField) firstErrorField = 'bi_tel';
            }

            // Validate Billing Email (required, email format)
            if (!bi_email) {
                showFieldError('bi_email', 'Email is required');
                isValid = false;
                if (!firstErrorField) firstErrorField = 'bi_email';
            } else if (!validateEmail(bi_email)) {
                showFieldError('bi_email', 'Please enter a valid email address (e.g., user@example.com)');
                isValid = false;
                if (!firstErrorField) firstErrorField = 'bi_email';
            }
            ...
            if (!de_contact) {
                showFieldError('de_contact', 'Contact is required');
                isValid = false;
                if (!firstErrorField) firstErrorField = 'de_contact';
            }

            // Validate Delivery Address
            if (!de_address) {
                showFieldError('de_address', 'Address is required');
                isValid = false;
                if (!firstErrorField) firstErrorField = 'de_address';
            }

            // Validate Delivery City
            if (!de_city) {
                showFieldError('de_city', 'City is required');
                isValid = false;
                if (!firstErrorField) firstErrorField = 'de_city';
            }

            // Validate Delivery Country
            if (!de_country) {
                showFieldError('de_country', 'Country is required');
                isValid = false;
                if (!firstErrorField) firstErrorField = 'de_country';
            }

            // Validate Delivery Zipcode
            if (!de_zip_code) {
                showFieldError('de_zip_code', 'Zipcode is required');
                isValid = false;
                if (!firstErrorField) firstErrorField = 'de_zip_code';
            }

            // Validate Delivery Tel (required, phone format)
            if (!de_tel) {
                showFieldError('de_tel', 'Tel. is required');
                isValid = false;
                if (!firstErrorField) firstErrorField = 'de_tel';
            } else if (!validatePhoneNumber(de_tel)) {
                showFieldError('de_tel', 'Please enter a valid telephone number (only numbers, -, (), and spaces allowed, min 7 digits)');
                isValid = false;
                if (!firstErrorField) firstErrorField = 'de_tel';
            }

            // Validate Delivery Email (required, email format)
            if (!de_email) {
                showFieldError('de_email', 'Email is required');
                isValid = false;
                if (!firstErrorField) firstErrorField = 'de_email';
            } else if (!validateEmail(de_email)) {
                showFieldError('de_email', 'Please enter a valid email address (e.g., user@example.com)');
                isValid = false;
                if (!firstErrorField) firstErrorField = 'de_email';
            }
        ...
        function validateOrderStep() {
            const gameEventDate = $('input[name="game_event_date"]').val();
            const reqDueDate = $('input[name="req_due_date"]').val();

            if (!gameEventDate) {
                alert("Game / Event date is required.");
                $('input[name="game_event_date"]').focus();
                return false;
            }
            if (!reqDueDate) {
                alert("Request due date is required.");
                $('input[name="req_due_date"]').focus();
                return false;
            }

            // Check that request due date is not before game event date
            if (new Date(reqDueDate) < new Date(gameEventDate)) {
                alert("Request due date cannot be before Game / Event date.");
                $('input[name="req_due_date"]').focus();
                return false;
            }
        ...
        // Handle main tab clicks with validation
        tabs.forEach(tab => {
            tab.addEventListener('click', (event) => {
                const href = tab.getAttribute('href');
                const targetTabId = href.substring(1); // Remove '#' from href
                const currentActiveTab = document.querySelector('.tab-pane.show');
                const currentTabId = currentActiveTab ? currentActiveTab.id : 'billing';

                // Prevent navigation if trying to skip ahead without completing previous steps
                if (targetTabId === 'order' && !completedSteps.billing) {
                    event.preventDefault();
                    alert("Please complete Billing & Delivery Information first.");
                    return false;
                }
                if (targetTabId === 'team' && !completedSteps.order) {
                    event.preventDefault();
                    alert("Please complete Order Information first.");
                    return false;
                }
        ...
        window.validateBillingStep = validateBillingStep;
        window.validateOrderStep = validateOrderStep;
        window.completedSteps = completedSteps;

        // Clear errors when user types
        const step1Fields = ['bi_company_name', 'bi_contact', 'bi_country', 'bi_city', 'bi_zip_code', 'bi_email', 'bi_tel', 'bi_tax_id', 'bi_address',
                            'de_company_name', 'de_contact', 'de_country', 'de_city', 'de_zip_code', 'de_email', 'de_tel', 'de_tax_id', 'de_address'];
...
<script>
    ...
    function chooseUploadProcess(ele=false) {
        ...
        // Mark team step as completed
        if (window.completedSteps) {
            window.completedSteps.team = true;
        } 
    ...
    $(document).ready(function() {
        $('#AddNewTeamModal').click(function() {
            var teamName = $('#input_on_team_name_new').val().trim();
            var year = $('#input_on_year_new').val().trim();

            if (teamName == "") {
                alert("Please fill the Team Name.");
                $('#input_on_team_name_new').focus();
                return false;
            }

            if (year == "") {
                alert("Please fill the Year.");
                $('#input_on_year_new').focus();
                return false;
            }
    ...
    $(document).ready(function() {
        ...
        $('#showTeamTabsSection').click(function() {
            ...
            // Validate Team Name and Year (required fields)
            var teamName = $('#input_on_team_name').val().trim();
            var year = $('#input_on_year').val().trim();

            if (teamName == "") {
                alert("Please fill the Team Name.");
                $('#input_on_team_name').focus();
                return false;
            }
            ...
            var on_team_name = window.btoa(teamName);

            var on_year = window.btoa(year);
...
<script>
    ...
    //     // Handle Step 1 Continue button (Billing to Order)
    //     document.getElementById('btn-step1-continue').addEventListener('click', function(e) {
    //         e.preventDefault();

    //         if (typeof validateBillingStep === 'function') {
    //             if (validateBillingStep()) {
    //                 // Mark billing as completed
    //                 if (window.completedSteps) {
    //                     window.completedSteps.billing = true;
    //                 }
    ...
    //                 if (billingTab) {
    //                     billingTab.classList.remove('show', 'active');
    //                 }
    //                 if (orderTab) {
    //                     orderTab.classList.add('show', 'active');
    //                 }
    ...
    //                     if (navLink.getAttribute('href') === '#order') {
    ...
    //     // Handle Step 2 Continue button (Order to Team)
    //     document.getElementById('btn-step2-continue').addEventListener('click', function(e) {
    //         e.preventDefault();

    //         if (typeof validateOrderStep === 'function') {
    //             if (validateOrderStep()) {
    //                 // Mark order as completed
    //                 if (window.completedSteps) {
    //                     window.completedSteps.order = true;
    //                 }
    ...
    //                 if (orderTab) {
    //                     orderTab.classList.remove('show', 'active');
    //                 }
    //                 if (teamTab) {
    //                     teamTab.classList.add('show', 'active');
    //                 }
    ...
    //     // Handle Go Back buttons (allow without validation)
    ...
    //             const currentTab = document.querySelector('#myTabContent .tab-pane.show');
