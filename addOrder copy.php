                        ...
                        <div class="grid2">
                            <div class="boxes">
                                ...
                                <fieldset class="grid2 singleFrom">
                                    ...
                                    <div class="form-group column2">
                                        <label for="" class="w-100 text-start  c-label">Address</label>
                            ...
                            <div class="submitBUtton column2">
                                <a class="themeBtn switch-tab iconBTn" data-target="#order" data-bs-toggle="tab" href="#order" role="tab"
                                aria-controls="order" aria-selected="false">
                ...
                <div class="tab-pane fade" id="order">
                            ...
                            <!-- <div>
                                <div class="form-group position-relative ">
                                    ...
                                    <select name="" id="" disabled="disabled">
                                        <?php
                                        $sql_new = "SELECT * FROM employee WHERE employee_email='$user_email'";
                                        $emps = $conn3->query($sql_new);
                                        $num_rows = $emps->num_rows;
                                        if ($num_rows > 0) {
                                            while ($row_selection = $emps->fetch_assoc()) {
                                    ...
                                    <input type="text" name="reorder_num" placeholder="Reorder? Type the EX# here" id="reorder_num" style="width: 100%;">
                                    <a class="nav-link d-flex" id="PreviewPdfMdoal " style="cursor: pointer;" onclick="return PreviewPdfMdoal();" data-bs-toggle="modal" data-bs-target="#PreviewPdfMdoal">
                                        <ion-icon name="eye-outline"></ion-icon>
                                    </a>
                                </div>
                            </div> -->
                    ...
                    <div class="d-flex justify-content-between my-4">
                        ...
                        <div class="submitBUtton">
                            <a href="#" class="themeBtn switch-tab iconBTn" data-target="#team">Save and Continue <figure class="m-0"><img src="images/vector/nextBtn.png" alt=""></figure></a>
                        </div>
                    </div>
                </div>
