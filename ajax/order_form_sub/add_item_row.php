...
?>
	<tr id="prod_item_<?php echo $form_id; ?>_<?php echo $row_id; ?>" class="add_item_row_sub_222">
		...
		?>
		<td>
			<select class="white_in" id="select_mf_<?php echo $form_id; ?>_<?php echo $row_id; ?>" name="select_mf[<?php echo $form_id; ?>][]" onchange="return changeMF(<?php echo $form_id; ?>,<?php echo $row_id; ?>,2);">
		...
		<td>
			<select class="white_in" id="select_ssize_<?php echo $form_id; ?>_<?php echo $row_id; ?>" name="select_ssize[<?php echo $form_id; ?>][]">
				<option value="0"></option>
				<?php for($i=0; $i<sizeof($a_size["2"]);$i++){ ?>
				<option value="<?php echo $a_size["2"][$i]["size_id"]; ?>" ><?php echo $a_size["2"][$i]["size_name"]; ?></option>
				<?php } ?>
			</select>
		</td>
		<td><input class="white_in" name="sock_color[<?php echo $form_id; ?>][]" type="text" maxlength="100"></td>
